...
export type Job = { id: string; name: string; projectId: string; projectName?: string };
export type LogInput = { projectId: string; jobId: string; employeeId: string; date: string; minutes: number; workItem?: string; description: string; billable: boolean };
